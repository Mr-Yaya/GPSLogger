...
import static eu.ybenouag.gpslogger.GPSApplication.FILE_EMPTY_GPX;
import static eu.ybenouag.gpslogger.GPSApplication.FILE_EMPTY_KML;
import static eu.ybenouag.gpslogger.GPSApplication.FILETYPE_KML;
import static eu.ybenouag.gpslogger.GPSApplication.FILETYPE_GPX;
...
//        fileTypeList.add(new FileType(gpxList, "application/gpx+xml", FILETYPE_GPX));
        ...
        for (FileType ft : fileTypeList) {
            ...
            Uri uri = FileProvider.getUriForFile(GPSApplication.getInstance(), "eu.ybenouag.gpslogger.fileprovider", file);
